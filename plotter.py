...
def plot_trajectories():
    ...
    try:
        ...
        centerline_file = os.path.join(CENTERLINE_FOLDER, f"I-294-L1-Run_{run_index}-geometry-with-ramps.csv")
        ...
        fig.write_html("L1_Full_Plot.html")
